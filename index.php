...
$router->add('snapshot from sitemap <url>', static function (array $args) use ($snapshot, $timestamp) : void {
...
$router->add('snapshot <urls>...', static function (array $args) use ($snapshot, $timestamp) : void {
    $urls = $args['urls'];
